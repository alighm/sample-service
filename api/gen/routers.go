...
func NewRouter(routers ...Router) *mux.Router {
	...
	allowedOrigins := handlers.AllowedOrigins(viper.GetStringSlice("cors.origins"))
	allowedMethods := handlers.AllowedMethods(viper.GetStringSlice("cors.methods"))
	allowedHeaders := handlers.AllowedHeaders(viper.GetStringSlice("cors.headers"))
